...
//           d2mh_lim = SIGN(d2mh) * MIN(C * MIN(FABS(d2m1), FABS(d2c)), FABS(d2mh));
//
//         if ((wmh - wm1) * (wc  - wmh) < 0.)
...
//           d2ph_lim = SIGN(d2ph) * MIN(C * MIN(FABS(d2c), FABS(d2p1)), FABS(d2ph));
//
//         if ((wph - wc) * (wp1 - wph) < 0.)
...
//           d2hc_lim = SIGN(d2hc) * MIN(C * MIN(FABS(d2m1), FABS(d2c)),
